...
namespace RestaurantOrders.Database.Migrations
{
    ...
    [Migration("20250520144737_populatingRestaurantStockEntity")]
    partial class populatingRestaurantStockEntity
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("RestaurantOrders.Database.Entities.RestaurantStock", b =>
                {
                    b.HasOne("RestaurantOrders.Database.Entities.Product", "Product")
                        .WithOne()
                        .HasForeignKey("RestaurantOrders.Database.Entities.RestaurantStock", "ProductId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
